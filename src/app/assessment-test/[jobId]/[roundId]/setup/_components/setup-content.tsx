...
interface AssessmentSetupContentProps {
    jobId: string;
    roundId: string;
}

export default function AssessmentSetupContent({ jobId, roundId }: AssessmentSetupContentProps) {
    ...
    const handleStartAssessmentClick = () => {
        router.push(`/assessment-test/${jobId}/${roundId}/test`);
    }
