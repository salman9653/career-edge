...
import { JobsToolbar, type FilterState } from './jobs-toolbar';
...
export function CandidateJobsContent() {
    ...
    const getRecommendations = async () => {
        ...
        try {
            ...
            const recommendedJobsQuery = query(
              collection(db, 'jobs'),
              where('searchKeywords', 'array-contains-any', keywords.keywords.slice(0, 10)) 
            );
