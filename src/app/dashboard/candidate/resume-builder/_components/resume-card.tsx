...
import { Trash2, Pencil, Sparkles, Loader2, AlertTriangle } from 'lucide-react';
        ...
        <>
            ...
            <ContextMenu>
                ...
                <ContextMenuContent>
                    ...
                    <ContextMenuItem onSelect={() => setIsDeleteOpen(true)} className="text-destructive focus:text-destructive">
