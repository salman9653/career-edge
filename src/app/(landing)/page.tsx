          ...
          <div className="space-y-24">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground">
                  Stop wasting time on irrelevant listings. Our advanced AI
                  algorithms analyze skills, experience, and cultural fit to
                  connect the right candidates with the right companies
                  instantly.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground">
                  Access a worldwide pool of talent and opportunities without
                  geographical limits. Whether you're looking for remote work or
                  relocating, we've got you covered.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <CheckCircle2 className="h-5 w-5 text-green-500" />{" "}
                    <span>Access to 100+ Countries</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle2 className="h-5 w-5 text-green-500" />{" "}
                  ...
                  <li className="flex items-center gap-3">
                    <CheckCircle2 className="h-5 w-5 text-green-500" />{" "}
                    <span>Seamless Cross-border Hiring</span>
                  </li>
                </ul>
              </motion.div>
              <motion.div
            ...
            {[
              {
                ...
                quote:
                  "Career Edge helped me find a job that perfectly aligns with my career goals in less than a week!",
              },
              {
                name: "TechCorp Inc.",
                role: "Hiring Partner",
                quote:
                  "The quality of candidates we receive through this platform is unmatched. It has revolutionized our hiring.",
              },
              {
                name: "David M.",
                role: "Product Manager",
                quote:
                  "The AI resume analysis gave me insights I never considered. Highly recommended for any job seeker.",
              },
            ].map((testimonial, i) => (
              <motion.div
                key={i}
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-6">
                  Ready to take the next step in your career? Get personalized
                  job matches and tools to help you stand out.
                </p>
                <ul className="space-y-3 mb-8 text-muted-foreground">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500" /> AI
                    Resume Analysis
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500" /> Smart
                    Job Recommendations
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500" />{" "}
                ...
                <Button className="w-full sm:w-auto" asChild>
                  <Link href="/candidates">
                    Find Your Dream Job <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-6">
                  Building a world-class team? Streamline your hiring process
                  with our AI-powered recruitment suite.
                </p>
                <ul className="space-y-3 mb-8 text-muted-foreground">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500" />{" "}
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500" /> Advanced
                    Applicant Tracking
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500" /> Quality
                    Talent Pool
                  </li>
                </ul>
                <Button className="w-full sm:w-auto" variant="outline" asChild>
                  <Link href="/companies">
                    Hire Top Talent <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
              </div>
            </motion.div>
