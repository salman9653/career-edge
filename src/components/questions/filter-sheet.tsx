...
import type { FilterState } from './questions-table';
...
const typeOptions = ['mcq', 'subjective', 'code', 'screening'];
...
export function FilterSheet({ filters, onFilterChange, availableCategories, availableCreators = [] }: FilterSheetProps) {
  ...
  const clearFilters = () => {
    const clearedFilters = { type: [], category: [], difficulty: [], createdBy: [] };
  ...
  const activeFilterCount =
    filters.type.length + filters.category.length + filters.difficulty.length + filters.createdBy.length;
